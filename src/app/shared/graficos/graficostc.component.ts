...
@Component({
  selector: 'app-graficos-tat-com',
  standalone: true,
  template: `<div id="chart_div2" style="width: 100%; height: 500px;"></div>`,
  styleUrls: ['./graficos.component.scss']
})
export class GraficosTatComComponent implements AfterViewInit, OnChanges {
  ...
  drawChart(): void {
    ...
    if (this.datosGraficoTat && this.datosGraficoTat.length) {
      const data = google.visualization.arrayToDataTable([
        ['Mes', 'Dinero ingresado al estudio'],
      ...
      const options = {
        title: 'Comisiones mensuales por tatuajes del tatuador',
      ...
      this.chart = new google.visualization.ColumnChart(document.getElementById('chart_div2'));
